...
// Mapping názvů školení pro zobrazení
const trainingDisplayNames: Record<string, string> = {
  ...
  SystemmanagemenntuKvalityCilepodniku: 'Systém managementu kvality',
  ...
  PozdavkyEN10204Dodak: 'Požadavky EN10204',
...
export default function AdminPrehledPage() {
  ...
  const [selectedTraining, setSelectedTraining] = useState<string>('CMM');
      ...
      <div className="w-full space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Editace školení a termínů pro jednotlivé uživatele
            </CardDescription>
          </CardHeader>
