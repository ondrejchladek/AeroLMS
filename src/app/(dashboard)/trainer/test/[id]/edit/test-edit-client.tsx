...
export default function TestEditClient({ test }: TestEditClientProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error(error instanceof Error ? error.message : 'Chyba při ukládání testu');
    } finally {
      setIsLoading(false);
    }
  };
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Upravte základní nastavení testu
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex gap-3">
                ...
                <Button
                  type="button"
                  variant="outline"
                  onClick={() => router.push(`/trainer/training/${test.training.code}/tests`)}
                  disabled={isLoading}
                >
                  Zrušit
                </Button>
